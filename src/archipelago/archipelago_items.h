...
// Item definitions - use a function for C++11/14 compatibility
inline const std::vector<ItemDef>& GetItemDefinitions() {
    static const std::vector<ItemDef> ITEM_DEFINITIONS = {
    // ===== PROGRESSION ITEMS =====
    ...
    {4004, "Grenade Bandolier", "GrenadeBandolier", ItemCategory::EQUIPMENT,
     static_cast<int>(ItemFlag::ESSENTIAL) | static_cast<int>(ItemFlag::UPGRADE_ITEM), 1},

    // ===== HEALTH ITEMS =====
    {5001, "Small Health Pack", "Stimpack", ItemCategory::HEALTH, static_cast<int>(ItemFlag::FILLER), 999},
    {5002, "Large Health Pack", "Medkit", ItemCategory::HEALTH, static_cast<int>(ItemFlag::FILLER), 999},
    ...
    {5005, "Health Upgrade", "HealthUpgrade", ItemCategory::UPGRADE,
     static_cast<int>(ItemFlag::ESSENTIAL) | static_cast<int>(ItemFlag::UPGRADE_ITEM), 10},

    // ===== ARMOR ITEMS =====
    {6001, "Light Armor", "CommonArmor", ItemCategory::ARMOR, static_cast<int>(ItemFlag::FILLER), 999},
    {6002, "Combat Armor", "RareArmor", ItemCategory::ARMOR, static_cast<int>(ItemFlag::FILLER), 999},
    {6003, "Heavy Armor", "EpicArmor", ItemCategory::ARMOR, 0, 999},
    {6004, "Admiral Armor", "LegendaryArmor", ItemCategory::ARMOR, 0, 999},
    {6005, "Armor Shard", "ArmorShardPickup", ItemCategory::ARMOR, static_cast<int>(ItemFlag::FILLER), 999},

    // ===== AMMO PICKUPS =====
    {7001, "Pistol Ammo", "AmmoPistolSmall", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7002, "Shotgun Shells (Small)", "AmmoShotgunSmall", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7003, "Shotgun Shells (Medium)", "AmmoShotgunMedium", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7004, "Shotgun Shells (Large)", "AmmoShotgunLarge", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7005, "Rifle Ammo (Small)", "AmmoRifleSmall", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7006, "Rifle Ammo (Medium)", "AmmoRifleMedium", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7007, "Rifle Ammo (Large)", "AmmoRifleLarge", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7008, "Grenade Ammo", "AmmoGrenadeSmall", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7009, "Nailgun Ammo (Small)", "AmmoNailgunSmall", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7010, "Nailgun Ammo (Medium)", "AmmoNailgunMedium", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7011, "DMR Ammo", "AmmoSniperMedium", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7012, "Plasma Ammo (Small)", "AmmoEnergySmall", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7013, "Plasma Ammo (Large)", "AmmoEnergyLarge", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7014, "Railgun Slug", "AmmoRailgunSmall", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    {7015, "Acid Ammo", "AmmoGLAcid", ItemCategory::AMMO, static_cast<int>(ItemFlag::FILLER), 999},
    ...
    // ===== CONSUMABLES =====
    {9001, "Credits (Small)", "CreditsSmall", ItemCategory::CONSUMABLE, static_cast<int>(ItemFlag::FILLER), 999},
    {9002, "Credits (Medium)", "CreditsbagMedium", ItemCategory::CONSUMABLE, static_cast<int>(ItemFlag::FILLER), 999},
    {9003, "Credits (Large)", "CreditsbagLarge", ItemCategory::CONSUMABLE, static_cast<int>(ItemFlag::FILLER), 999},
    {9004, "Weapon Parts", "WeaponPartPickup", ItemCategory::CONSUMABLE, static_cast<int>(ItemFlag::FILLER), 999},
    {9005, "Weapon Capacity Kit", "WeaponCapacityKit", ItemCategory::UPGRADE,
     static_cast<int>(ItemFlag::ESSENTIAL) | static_cast<int>(ItemFlag::UPGRADE_ITEM), 20},
    {9006, "Workshop Tech Module", "TechModule", ItemCategory::UPGRADE,
     static_cast<int>(ItemFlag::ESSENTIAL) | static_cast<int>(ItemFlag::UPGRADE_ITEM), 6}
};
    return ITEM_DEFINITIONS;
}

// Map definitions
inline const std::vector<std::string>& GetMapList() {
